...
import { getProductById, getSlug, getProducts } from '../../utils'
...
const ProductDetails: NextPage<Props>  = ({ productDetails }) => {
            ...
            {productDetails.breadcrumbs.map((breadcrumb) => (
              <li key={breadcrumb.id}>
                <div className="flex items-center">
                  <Link href={breadcrumb.href} className="mr-4 text-sm font-medium text-gray-900 capitalize">
                    {breadcrumb.name}
                  </Link>
                  <svg
                    viewBox="0 0 6 20"
          ...
          <div className="lg:grid lg:auto-rows-min lg:grid-cols-12 lg:gap-x-8">
            <div className="lg:col-span-5 lg:col-start-8">
              <div className="flex justify-between">
                ...
                <p className="text-xl font-medium text-gray-900">{productDetails.price}</p>
              </div>
              {/* Reviews */}
              <div className="mt-4">
                ...
                <div className="flex items-center">
                    ...
                    {[0, 1, 2, 3, 4].map((rating) => (
                      <StarIcon
                        ...
                        className={classNames(
                          productDetails.rating.rate > rating ? 'text-yellow-400' : 'text-gray-200',
                  ...
                  <div className="ml-4 flex">
                    <a href="#" className="text-sm font-medium text-indigo-600 hover:text-indigo-500">
                      See all {productDetails.reviewCount} reviews
                    </a>
                  </div>
                </div>
              </div>
  ...
  try { 
    ...
    const productUI: ProductUI = {
      ...
      colors: [
        { name: 'Black', bgColor: 'bg-gray-900', selectedColor: 'ring-gray-900' },
        { name: 'Heather Grey', bgColor: 'bg-gray-400', selectedColor: 'ring-gray-400' },
        { name: 'Green', bgColor: 'bg-green-400', selectedColor: 'ring-green-400' },
      ],
      sizes: [
        { name: 'XXS', inStock: true },
        { name: 'XS', inStock: true },
